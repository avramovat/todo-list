...
import { Dot, DotContainer } from '../../styles/components/Desktop/TaskDots'; 
import {Tooltip} from '../../styles/components/Desktop/Tooltip';
...
const TaskDotsWithTooltip = ({ dayTasks, onDateClick }) => {
  ...
  return (
    <DotContainer>
      ...
      {tooltip.visible && (
        <Tooltip style={{ top: tooltip.y, left: tooltip.x, display: 'block' }}>
          {tooltip.text}
        </Tooltip>
      )}
    </DotContainer>
