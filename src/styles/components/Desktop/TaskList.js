...
// align-items: center;
// padding: 0.5vw 1vw;
// position: sticky; /* ова го прави фиксно во контејнерот */
// top: 0;
// background-color: rgba(255, 255, 255, 0.9); /* позадина за да не се преклопува */
// z-index: 10;
// backdrop-filter: blur(8px); /* за поубаво стаклено чувство ако имаш background transparency */
// `;
